...
=============================================================
In this computer vision example two faces are used from the LFW 
...
from sklearn import datasets, naive_bayes, neighbors
...
idx = np.where((data.target == majority_person) |
               (data.target == minority_person))[0]
X = data.data[idx]
y = data.target[idx]
