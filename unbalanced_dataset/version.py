...
_UNBALANCED_DATASET_INSTALL_MSG = 'See %s for installation information.' % (
...
def _check_module_dependencies(is_unbalanced_dataset_installing=False):
    ...
    for (module_name, module_metadata) in REQUIRED_MODULE_METADATA:
        if not (is_unbalanced_dataset_installing and
